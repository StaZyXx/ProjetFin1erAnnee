...
class View:
    def __init__(self):
        ...
        while self.__running:
            for event in pygame.event.get():  # récupérer un event
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    self.__cursor_pos = pygame.mouse.get_pos()
                    if self.__get_multiplayer.collidepoint(self.__cursor_pos):
                        print("multiplayer")
                    elif self.__get_leave.collidepoint(self.__cursor_pos):
                        print("leave")
    ...
    def page2(self):
        ...
        pygame.draw.rect(self.__blue_image, self.__BLUE, (100, 0, 1000, 500))

        pygame.draw.rect(self.__blue_image, self.__DARK_BLUE, (100, 100, 200, 75))
